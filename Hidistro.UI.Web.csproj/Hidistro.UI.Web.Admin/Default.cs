	...
	public class Default : AdminPage
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!base.IsPostBack)
            {
				...
				System.Data.DataRow drOne = ShopStatisticHelper.ShopGlobal_GetMemberCount(TenantID);
				System.Data.DataRow drOne2 = ShopStatisticHelper.ShopGlobal_GetOrderCountByDate(today, TenantID);
				System.Data.DataRow drOne3 = ShopStatisticHelper.ShopGlobal_GetOrderCountByDate(today.AddDays(-1.0), TenantID);
				...
				this.rptDistributor.DataSource = ShopStatisticHelper.ShopGlobal_GetSortList_Distributor(beginDate, 8, TenantID);
				this.rptDistributor.DataBind();
				this.rptMember.DataSource = ShopStatisticHelper.ShopGlobal_GetSortList_Member(beginDate, 8, TenantID);
		...
		protected override void Render(System.Web.UI.HtmlTextWriter writer)
		{
			...
			System.Web.UI.HtmlTextWriter writer2 = new System.Web.UI.HtmlTextWriter(stringWriter);
			base.Render(writer2);
