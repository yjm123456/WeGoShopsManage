...
namespace Hidistro.UI.Web.Admin.Member
{
	public class UserGroupSet : AdminPage
	{
        ...
        private string TenantID = ManagerHelper.GetCurrentTenantID();
		...
		{
			this.txt_time.Value = MemberHelper.SelectUserGroupSet(TenantID).ToString();
		}
		...
		protected void btnSaveClientSettings_Click(object sender, System.EventArgs e)
		{
			...
			if (MemberHelper.SetUserGroup(System.Convert.ToInt32(this.txt_time.Value),TenantID) > 0)
			{
