...
namespace Hidistro.UI.Web.API
{
	public class MenuProcess : System.Web.IHttpHandler, System.Web.SessionState.IRequiresSessionState
	{
        ...
        public string TenantID= ManagerHelper.GetCurrentTenantID();
		...
		public void GetMenu(System.Web.HttpContext context)
		{
			...
			menuInfo = MenuHelper.GetMenu(menuId,TenantID);
			if (menuInfo != null)
			{
				text += "\"status\":\"0\",\"data\":[";
				object obj = text;
		...
		public void updatename(System.Web.HttpContext context)
		{
			...
			if (num > 0)
			{
				MenuInfo menu = MenuHelper.GetMenu(num,TenantID);
		...
		public void AddMenus(System.Web.HttpContext context)
		{
			...
			menuInfo.ShopMenuPic = context.Request["ShopMenuPic"];
            menuInfo.TenantID = TenantID;
			if (MenuHelper.CanAddMenu(menuInfo.ParentMenuId,TenantID))
			{
		...
		public void GetTopMenus(System.Web.HttpContext context)
		{
			context.Response.ContentType = "application/json";
			string text = "{";
			System.Collections.Generic.IList<MenuInfo> topMenus = MenuHelper.GetTopMenus(TenantID);
			SiteSettings masterSettings = SettingsManager.GetMasterSettings(false);
			if (topMenus.Count <= 0)
			{
				text += "\"status\":\"-1\"";
			...
			{
				System.Collections.Generic.IList<MenuInfo> menusByParentId = MenuHelper.GetMenusByParentId(current.MenuId,TenantID);
				object obj2 = text;
				text = string.Concat(new object[]
				{
					obj2,
