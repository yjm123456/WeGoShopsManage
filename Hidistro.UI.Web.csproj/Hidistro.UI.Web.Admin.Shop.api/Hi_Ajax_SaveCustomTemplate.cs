		...
		public void ProcessRequest(System.Web.HttpContext context)
		{
			...
			try
            {
				...
				if (customPageStatus == CustomPageStatus.正常)
				{
                    ...
                    customPageByID.TenantID = manager.TenantID;
                ...
                if (customPageStatus == CustomPageStatus.正常)
				{
					...
					System.IO.StreamWriter streamWriter = new System.IO.StreamWriter(context.Server.MapPath(text5 + "/Skin-HomePage"+manager.TenantID+".html"), false, System.Text.Encoding.UTF8);
					string text6 = text4;
				...
				else
				{
					...
					System.IO.StreamWriter streamWriter2 = new System.IO.StreamWriter(context.Server.MapPath(text8 + "/Skin-HomePage"+manager.TenantID+".html"), false, System.Text.Encoding.UTF8);
					string text9 = text7;
