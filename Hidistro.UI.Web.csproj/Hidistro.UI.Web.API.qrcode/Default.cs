	...
	public class Default : System.Web.UI.Page
	{
		...
		protected string GetImgUrl()
		{
			...
			if (scanInfosByUserId != null && !string.IsNullOrEmpty(scanInfosByUserId.CodeUrl))
			{
				...
				Globals.Debuglog("qrCodeResult:"+result, "_Debuglog.txt");
			}
			else
			{
				...
				Globals.Debuglog("tokenMsg:"+token_Message, "_Debuglog.txt");
				if (TokenApi.CheckIsRightToken(token_Message))
				{
					...
					Globals.Debuglog("ticket:" + token_Message, "_Debuglog.txt");
