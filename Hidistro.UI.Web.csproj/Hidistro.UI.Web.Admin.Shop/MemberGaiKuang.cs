...
namespace Hidistro.UI.Web.Admin.Shop
{
	public class MemberGaiKuang : AdminPage
	{
		...
		private void LoadData()
		{
            ...
            System.Data.DataRow dataRow = ShopStatisticHelper.MemberGlobal_GetCountInfo(TenantID);
			if (dataRow != null)
			{
			...
			System.Data.DataTable dataTable = ShopStatisticHelper.MemberGlobal_GetStatisticList(1,TenantID);
			System.Data.DataTable dataTable2 = ShopStatisticHelper.MemberGlobal_GetStatisticList(2,TenantID);
