	...
	public class Hi_Ajax_SaveTemplate : System.Web.IHttpHandler
	{
		...
		public void ProcessRequest(System.Web.HttpContext context)
		{
			...
			try
			{
                ...
                if (manager == null)
                {
                    throw new ArgumentNullException("商户未登录！");
                }
                System.IO.StreamWriter streamWriter = new System.IO.StreamWriter(context.Server.MapPath("/Templates/vshop/" + text2.Trim() + "/data/default"+ manager.TenantID + ".json"), false, System.Text.Encoding.UTF8);
				string text5 = text;
                ...
                manager.tMenu = text2;
                ManagerHelper.Update(manager);
                System.IO.StreamWriter streamWriter2 = new System.IO.StreamWriter(context.Server.MapPath(text7 + "/Skin-HomePage"+manager.TenantID+".html"), false, System.Text.Encoding.UTF8);
				string text8 = text6;
