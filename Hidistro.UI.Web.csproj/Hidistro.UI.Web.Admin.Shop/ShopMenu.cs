	...
	public class ShopMenu : AdminPage
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!base.IsPostBack)
			{
                ...
                //限制控件点击
                this.ShopDefault.Enabled = false;
                this.MemberDefault.Enabled = false;
                this.GoodsType.Enabled = false;
                this.GoodsCheck.Enabled = false;
                this.ActivityMenu.Enabled = false;
                this.DistributorsMenu.Enabled = false;
                this.GoodsListMenu.Enabled = false;
                this.BrandMenu.Enabled = false;
            }
		...
		private void BtnSave_Click(object sender, System.EventArgs e)
		{
            ...
            var updateMenu = MenuHelper.UpdateShopMenuStyle(TenantID,Convert.ToInt32(this.RadioType.SelectedValue));
