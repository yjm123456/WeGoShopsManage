...
namespace Hidistro.ControlPanel.Members
{
    public static class CustomGroupingHelper
    {
        ...
        public static System.Data.DataTable GetCustomGroupingDataTable(string TenantID)
        {
            return new CustomGroupingDao().GetCustomGroupingTable(TenantID);
        }

        public static IList<CustomGroupingInfo> GetCustomGroupingList(string TenantID)
        {
            return new CustomGroupingDao().GetCustomGroupingList(TenantID);
        }

        public static IList<CustomGroupingInfo> GetCustomGroupingList(string TenantID,string customGroupIds = "")
        {
            return new CustomGroupingDao().GetCustomGroupingList(TenantID,customGroupIds);
        }
        ...
        public static IList<int> GetMemberList(MemberQuery query)
        {
            ...
            {
                list = memberDao.GetStoreNameMemberList(query.StoreName, TenantID);
            }
            else
            {
                list = memberDao.GetAllMemberList(TenantID);
            }
