...
{
    public abstract class JosConfiguration : Configuration
    {
        private const string SERVER_URL = "http://synccenter.jd.com/message/sub";

        public IConnectionLifeCycleListener ConnectionLifeCycleListener { get; set; }

        public JosConfiguration(string appKey, string appSecret, string connectId)
            : base(appKey, appSecret, null, connectId)
        {
            ...
            {
                cometReq.SetConnectListener(new JosConnectionLifeCycleListener(this));
            }
        }
    ...
    public class JosConnectionLifeCycleListener : IConnectionLifeCycleListener
    {
        private JosConfiguration conf;

        public JosConnectionLifeCycleListener(JosConfiguration conf)
        {
            this.conf = conf;
        }
