...
namespace Hidistro.SaleSystem.Vshop
{
	public class DistributorsBrower
	{
        ...
        public static decimal GetTeamMoneysBrowser(int userid, DateTime Begindata, DateTime EndData)
        {
            return new DistributorsDao().GetTeamMoneys(userid, Begindata, EndData);
        }
        public static System.Data.DataTable GetMyTeams(int UserID)
        {
            return new DistributorsDao().GetMyTeams(UserID);
        }
