		...
		protected override void AttachChildControls()
		{
			...
			else
			{
				...
				if (userIdDistributors != null && userIdDistributors.UserId > 0)
				{
                    ...
                    //是否需要查询月销售额
                    decimal returnMoney = DistributorsBrower.GetTeamMoneysBrowser(userIdDistributors.UserId, Convert.ToDateTime("2000-01-01"), Convert.ToDateTime("2000-01-01"));

					this.lblAlreadycommission.Money = returnMoney;
