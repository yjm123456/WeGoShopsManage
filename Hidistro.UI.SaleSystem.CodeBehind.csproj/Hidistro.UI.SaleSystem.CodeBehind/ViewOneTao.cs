...
namespace Hidistro.UI.SaleSystem.CodeBehind
{
	public class ViewOneTao : VMemberTemplatedWebControl
	{
        ...
        private string TenantID=MemberHelper.ReturnUserTenID();
		...
		protected override void AttachChildControls()
		{
			...
			if (num3 == 0 || oneTaoState != OneTaoState.进行中 || !MemberHelper.CheckCurrentMemberIsInRange(oneyuanTaoInfoById.FitMember, oneyuanTaoInfoById.DefualtGroup, oneyuanTaoInfoById.CustomGroup, this.CurrentMemberInfo.UserId,TenantID))
			{
			...
			text = "适用会员：" + text;
			if (oneyuanTaoInfoById.FitMember != "0" && !MemberHelper.CheckCurrentMemberIsInRange(oneyuanTaoInfoById.FitMember, oneyuanTaoInfoById.DefualtGroup, oneyuanTaoInfoById.CustomGroup, this.CurrentMemberInfo.UserId, TenantID))
			{
				text = "会员等级不符合活动要求";
