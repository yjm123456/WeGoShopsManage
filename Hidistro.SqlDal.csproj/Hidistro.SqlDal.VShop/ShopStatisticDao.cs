...
namespace Hidistro.SqlDal.VShop
{
	public class ShopStatisticDao
	{
		...
		public System.Data.DataRow ShopGlobal_GetOrderCountByDate(DateTime dDate,string TenantID)
		{
            ...
            this.database.AddInParameter(sqlStringCommand, "TenantID", System.Data.DbType.String, TenantID.ToString());
		...
		public System.Data.DataRow ShopGlobal_GetMemberCount(string TenantID)
		{
			System.Data.DataTable dataTable = new System.Data.DataTable();
            string sql = string.Format("\r\n              select  \r\n                ( select count(*)   from Hishop_Orders where OrderStatus=2 and TenantID={0}  or ( OrderStatus=1 and  Gateway='hishop.plugins.payment.podrequest' ) ) as 'WaitSendOrderQty',\r\n                ( select count(*)  from Hishop_Products  where SaleStatus=1 and TenantID={0}) as GoodsQty ,\r\n                ( select    COUNT(*)  from aspnet_Members where TenantID={0}) as  MemberQty,\r\n                ( select  COUNT(*) from aspnet_Distributors where  ReferralStatus<=1  and TenantID={0}) as DistributorQty,\r\n                (\r\n                    select COUNT(*) from\r\n                    (\r\n                    select COUNT(*) SumRec from  Hishop_OrderItems where OrderItemsStatus>=6 and  OrderItemsStatus<=8\r\n            and tenantid={0}        group by OrderId\r\n                    ) T1\r\n                ) as ServiceOrderQty\r\n               \r\n                ", "'"+TenantID+"'");
		...
		public System.Data.DataTable ShopGlobal_GetSortList_Distributor(DateTime BeginDate, int TopCount,string TenantID)
		{
            ...
            stringBuilder.AppendLine(" WHERE m.TenantID='"+TenantID+"' ");
		...
		public System.Data.DataTable MemberGlobal_GetStatisticList(int FuncID,string TenantID)
		{
			System.Data.DataTable dataTable = new System.Data.DataTable();
		...
		public System.Data.DataRow MemberGlobal_GetCountInfo(string TenantID)
		{
			System.Data.DataTable dataTable = new System.Data.DataTable();
			System.Data.Common.DbCommand storedProcCommand = this.database.GetStoredProcCommand("sp_Statistics_Member");
            this.database.AddInParameter(storedProcCommand, "TenantID", System.Data.DbType.String, TenantID);
		...
		public System.Data.DataRow Distributor_GetGlobalTotal(DateTime dYesterday,string TenantID)
		{
			System.Data.DataTable dataTable = new System.Data.DataTable();
			System.Data.Common.DbCommand sqlStringCommand = this.database.GetSqlStringCommand("\r\n\t            select \r\n\t            (select COUNT(*) from aspnet_Distributors where ReferralStatus<=1 AND TenantID=@TenantID) as DistributorNumber,\r\n\t            (\r\n\t            select  COUNT(*)\r\n\t\t            from aspnet_Distributors\r\n\t\t            where ReferralStatus<=1 AND TenantID=@TenantID and  CONVERT(varchar(10), CreateTime , 120 ) =  CONVERT(varchar(10), @RecDate  , 120 ) \r\n\t            ) as NewAgentNumber,\t\r\n\t            (\r\n\t            SELECT  ISNULL(SUM(Amount),0) from Hishop_BalanceDrawRequest   where isnull(IsCheck,0)=2 AND TenantID=@TenantID \r\n\t            ) as FinishedDrawCommissionFee,\r\n\t\r\n\t            (SELECT SUM(ReferralBlance) FROM aspnet_Distributors WHERE TenantID=@TenantID  ) as WaitDrawCommissionFee\r\n                ");
