...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 .g-flex{margin-left:2px}*/
    ...
    <script type="text/j-template" id="tpl_albums_main">
        ...
        <div class="fr">
                        <input type="text" placeholder="请输入图片名称" style="height:23px;width: 150px;padding:6px;vertical-align: 0;border-radius: 2px;border: 1px solid #ccc;"><a href="javascript:;" id="j-searchImg" class="btn btn-primary mgl10 searchImg">搜索</a></div>
                    </div>
