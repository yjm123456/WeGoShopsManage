...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="../js/CreateQrCode.js"></script>
    <script>
        ...
        $(function () {
            ...
            var status = "<%= status%>";
            var url="<%= showUrl%>";
            var name="customerPageImgQrcode";
            var imgCreate = CreateQrcode(url, name);
            var src = "../QrCodeImg/" + name + ".png";
        ...
        function winitemqrcode(url, title) {
            var name = title;
            var imgCreate = CreateQrcode(url, title);
            var src = "../QrCodeImg/" + title + ".png";
            $("#imageitemcode").attr('src', src);
