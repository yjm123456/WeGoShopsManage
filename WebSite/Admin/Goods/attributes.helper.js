...
function prepareSkus() {
    ...
    tableHeader.append($("<td align=\"center\" style=\"width:130px\">成交店铺佣金比例<\/td>"));
    tableHeader.append($("<td align=\"center\" style=\"width:130px\">上一级佣金比例<\/td>"));
    tableHeader.append($("<td align=\"center\" style=\"width:130px\">上二级佣金比例<\/td>"));
...
function addItem() {
    ...
    dataRow.append(createItemCommisssion(newRowIndex));
    dataRow.append(createSecondCommission(newRowIndex));
    dataRow.append(createThirdCommission(newRowIndex));
...
function createItemCommisssion(rowIndex) {
    var cell = createCell();
    var skuCodeCell = $(String.format("<input type=\"text\" class=\"form-control\" id=\"TxtItemCommission_{0}\" \/>", rowIndex));
...
function createSecondCommission(rowIndex) {
    var cell = createCell();
    var skuCodeCell = $(String.format("<input type=\"text\" class=\"form-control\" id=\"TxtSecondCommission_{0}\" \/>", rowIndex));
    if ($("#ctl00_ContentPlaceHolder1_txtSku").val().length > 0) $(skuCodeCell).val($("#ctl00_ContentPlaceHolder1_txtSku").val() + "-" + rowIndex);
    cell.append(skuCodeCell);
    return cell;
}
function createThirdCommission(rowIndex) {
    var cell = createCell();
    var skuCodeCell = $(String.format("<input type=\"text\" class=\"form-control\" id=\"TxtThirdCommission_{0}\" \/>", rowIndex));
    if ($("#ctl00_ContentPlaceHolder1_txtSku").val().length > 0) $(skuCodeCell).val($("#ctl00_ContentPlaceHolder1_txtSku").val() + "-" + rowIndex);
    cell.append(skuCodeCell);
    return cell;
}
