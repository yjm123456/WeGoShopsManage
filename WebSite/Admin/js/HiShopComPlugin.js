...
function tpl_albums_main() {
    var tempHtml = " <div id=\"albums\">\
        ...
        <div class=\"fr\">\
                        <input type=\"text\" placeholder=\"请输入图片名称\" style=\"height:23px;width: 150px;margin:4px;padding:0px;vertical-align: 0;border-radius: 2px;border: 1px solid #ccc;font-size:12px;line-height:22px;\"><a href=\"javascript:;\" id=\"j-searchImg\" class=\"btn btn-primary mgl10 searchImg\">搜索</a></div>\
                    </div>\
